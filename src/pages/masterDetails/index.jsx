...
const MasterDetailsPage = ({ creatorName, setAdminsList, adminsList = [] }) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(MasterDetailsPage);
